...
def ingrese_opcion():
	input_usuario = str(raw_input('Seleccione la opcion deseada: 1- Grafico de dispersion   2- Grafico de frecuencia 3-Salir\n'))
...
def resolver_menu(input_usario):
    ...
    if input_usario == '2':
		...
		palabras_plot = str(raw_input('Ingrese todas las palabras que desee separadas por un espacio\n'))
